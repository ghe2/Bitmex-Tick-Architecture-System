        ...
        module.exports = function (Chart) {
            ...
            Chart.controllers.candlestick = Chart.controllers.financial.extend({
                ...
                updateElement: function (element, index, reset) {
                    ...
                    me.updateElementGeometry(element, index, reset, options);
    ...
    3: [function (require, module, exports) {
        ...
        module.exports = function (Chart) {
            ...
            Chart.controllers.financial = Chart.controllers.bar.extend({
                 ...
                 * @private
                 */
                updateElementGeometry: function (element, index, reset, options) {
                    var me = this;
                    ...
                    model.candle = me.calculateCandleValuesPixels(me.index, index, options);
                },
        ...
        module.exports = function (Chart) {
            ...
            Chart.elements.Candlestick = Chart.elements.Financial.extend({
                draw: function () {
                    ...
                    //ctx.strokeRect(x - vm.width / 2, c, vm.width, o - c); // GOK - Cosmetic Patch (Removes Redundant borders)
                    ctx.closePath();
                },
            });
        };
